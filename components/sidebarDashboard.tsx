...
export default function SidebarDashboard({children}) {
    ...
    useEffect(() => {
        const fetchBalance = async () => {
            ...
            try {
                const response = await axios.post('/api/digiflazz/balance');
                // console.log(response)
                if (response.data?.error?.data){
                    console.log("resp err: ",response.data.error.data.message)
                    setError(response.data.error.data.message)
                }else {
                ...
                <nav className="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Global">
                    ...
                    <div
                        ...
                        <div className="flex flex-row items-center justify-end gap-4">
                            <button type="button"
                                    className="w-full h-full inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700"
                                    data-hs-offcanvas="#hs-offcanvas-right">
                                {balance}
                                <FaCirclePlus />
                            </button>
                            <div className='w-full h-full inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700'>
                                <ModeToggle/>
                            </div>
                            ...
                            <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                                ...
                                <div
                                    ...
                                    <div className="mt-2 py-2 first:pt-0 last:pb-0">
                                        <Link href="/dashboard/profile" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-200 dark:text-neutral-300 dark:hover:bg-neutral-700 rounded-md">
                                        ...
                                        <form action={handleSignOut}
                                              method="POST">
                                            <button className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300" type={"submit"}>
                                                <PiSignOutBold />
                                                Sign Out
                                            </button>
                                        </form>
